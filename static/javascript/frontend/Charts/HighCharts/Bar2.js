            ...
            init: function (observations, parameters, nDimensions) {
                ...
                var chart = {    
                    ...
                    getLabelsForElements: function(elements, parameters) {
                        var labels = [];
                        var dimensionComponents = parameters.selectedComponents.dimensions;
                    ...
                    getMeasures: function(parameters) {
                        for ( var label in parameters.selectedComponents.measures ) {
                            return parameters.selectedComponents.measures [label].type;
                        }
                    },

Namespacedotjs('org.aksw.CubeViz.Charts.HighCharts.Chart0', {
    ...
    getTitle: function(observations, parameters, nDimensions) {
        ...
        // simple concatenate labels together
        for(i = 0; i < dimComps_length; ++i) {
            dimCompsLabels.push(dimComps[i].property_label);
		}
		
		if(typeof dsdPart !== 'undefined' && "" != dsdPart)
			title += dsdPart;
		
		if(typeof dsPart !== 'undefined' && "" != dsPart)
			title += " - " + dsPart;

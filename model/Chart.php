...
abstract class Chart {
    ...
    public function __construct($dimensionData, $measureData, $nameTable, 
        ...
        //$dimensions - array( "dimension_URI" => "dimension_axis")
        //$measures - array( "measure_URI");
        //$titles - array( "title" => "", "subtitle" => "")
        //$model - Erfurt_Owl_Model object
        ...
        if(count($dimensions) >= static::$_limits['minDimension'] 
            ...
            // array(1) { ["measure"]=> string(5) "value" } 
            // always get the label of the measure (!)
            // the measure is always tied to the Y axis
                        
            //set the other axis
            //get the dimensions URI
            $xDimension = array_search('x', $dimensions);
            // array(2) { ["dimensionName"]=> string(9) "indicator" ["dimensionValues"]=> array(0) { } }            
            $this->_xAxis = array('dimensionName' => $nameTable['d'][$xDimension]['label'], 
                'dimensionValues' => array());
            //when given, also set the zAxis
            
            /******************************************************************
             * here is assumption, that one axis is x and other axis is z (!) *
             * first chosen axis can not be z (!)                             *
             ******************************************************************/
            ...
            if($twoDimensions) {
                ...
                $this->_zAxis = array('dimensionName' => $nameTable['d'][$zDimension]['label'], 
                    'dimensionValues' => array());
                // array(2) { ["dimensionName"]=> string(7) "country" ["dimensionValues"]=> array(0) { } } 
            }
            ...
            foreach ($dimensionData as $index=>$dimensionTuple) {
                ...
                if($twoDimensions) {
                    ...
                    if(!isset($tempData[$dimensionTuple[$dimQName0]]
                        ...
                        // array(1) { ["http://data.lod2.eu/scoreboard/indicators/e_broad_ENT_ALL_XFIN_ent"] 
                        //            => array(1) { ["Austria"]=> string(17) "4.841102957725525" } } 

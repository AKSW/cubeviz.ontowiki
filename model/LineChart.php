...
/**
 * Line chart model class for the ChartView component. This class adapts the
 * parameters of the default chart model to the line chart.
 *
 * @copyright Copyright (c) 2011, {@link http://aksw.org AKSW}
 * @license http://opensource.org/licenses/gpl-license.php GNU General Public License (GPL)
 * @category OntoWiki

...
class HighChartsParser extends Parser {
     ...
     * 
     */
    public function initialize ($chart) {
        ...
        // check data to prevent warnings etc.
        if ( ('ScatterPlotChart' == get_class ( $chart ) 
              && true == isset ( $this->_chartData['x']['measure'] )
              && true == isset ( $this->_chartData['y']['measure'] )) 
             || 
             ('ScatterPlotChart' != get_class ( $chart ) ) ){
            ...
            $this->_chartData['y']['dimensionValues'] = $this->_chartData['x']['dimensionValues'];
